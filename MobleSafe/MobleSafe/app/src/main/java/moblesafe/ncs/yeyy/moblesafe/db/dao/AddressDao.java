...
/**
 * 归属地查询的数据库
 * Created by yeyy on 2016/1/25.
 */
public class AddressDao {

    private static final String PATH = "data/data/moblesafe.ncs.yeyy.moblesafe/files/address.db";// 注意,该路径必须是data/data目录的文件,否则数据库访问不到
